...
SECRET_KEY = "django-insecure-r&olw!b2c)h=1(x8f)y-ie$he4t1**igy_89)aj9+d-ila9v8o"
...
# Celery
CELERY_BROKER_URL = getenv("RABBITMQ_URL", default="amqp://rabbit-mq")
...
CELERY_BEAT_SCHEDULE = {
    "generate_reports": {
        ...
        "schedule": timedelta(
            minutes=int(
                getenv("REPORT_GENERATION_FREQUENCY_MINS", default=60),
            )  # type: ignore
        ),
    }
}
